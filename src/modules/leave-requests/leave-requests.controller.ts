import { Controller, Post, Body, UseGuards, Request, HttpException, NotFoundException, BadRequestException, ConflictException, InternalServerErrorException, Param, Get } from "@nestjs/common"
...
export class LeaveRequestsController {
    ...
    async approveLeaveRequest(
        ...
        return this.leaveRequestsService.patchLeaveRequestStatus(id, dto.status, req.userId);
    }
